...
@export var attack_damage: int = 1 : set = set_attack_damage, get = get_attack_damage
...
func set_attack_damage(value: int) -> void: attack_damage = value
func get_attack_damage() -> int: return attack_damage
